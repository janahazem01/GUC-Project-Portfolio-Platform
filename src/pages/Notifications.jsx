              ...
              <div className="flex-1">
                ...
                {n.invitation && (
                  <div className="flex items-center gap-2 mt-3">
                    <Badge variant={statusVariant[n.invitation.status] || "default"}>{n.invitation.status}</Badge>
                    {n.invitation.status === "no reply" && (
                      <>
                        <Button size="sm" variant="secondary" onClick={() => respondToInvitation(n.invitation.projectId, n.invitation.id, "accepted", n.invitation.type)}>
                          Accept
                        </Button>
                        <Button size="sm" variant="danger" onClick={() => respondToInvitation(n.invitation.projectId, n.invitation.id, "rejected", n.invitation.type)}>
                          Reject
                        </Button>
                      </>
                    )}
